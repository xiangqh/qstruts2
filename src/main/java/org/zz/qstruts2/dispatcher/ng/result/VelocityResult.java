package org.zz.qstruts2.dispatcher.ng.result;
...
import org.zz.qstruts2.views.velocity.VelocityManager;
...
public class VelocityResult extends StrutsResultSupport {
	...
	private static final long serialVersionUID = 8342597914194798085L;
    ...
    public void doExecute(String finalLocation, ActionInvocation invocation) throws Exception {
        ...
        try {
            ...
            Context context = createContext(velocityManager, ActionContext.getContext(),request, response, finalLocation);
     ...
     */
    protected Context createContext(VelocityManager velocityManager, ActionContext ac, HttpServletRequest request, HttpServletResponse response, String location) {
